...
bool DMSound::Initialize( HWND hwnd )
{
	bool result;
	...
	//result = LoadWaveFile( "ambient.wav", &m_secondaryBuffer1, &m_secondary3DBuffer1 );
	result = LoadWaveFile( "ambient.wav", &m_secondaryBuffer1, &m_secondary3DBuffer1 );
	if( !result )
	{
		return false;
...
bool DMSound::InitializeDirectSound( HWND hwnd )
{
	HRESULT result;
...
void DMSound::ShutdownDirectSound( )
{
...
bool DMSound::LoadWaveFile( char* filename, IDirectSoundBuffer8** secondaryBuffer, IDirectSound3DBuffer8** secondary3DBuffer )
{
	int error;
	FILE* filePtr;
	unsigned int count;
...
void DMSound::ShutdownWaveFile( IDirectSoundBuffer8** secondaryBuffer, IDirectSound3DBuffer8** secondary3DBuffer )
{
