...
struct ImDrawData
{
    ...
    ~ImDrawData()   { Clear(); }
    void Clear()    { Valid = false; CmdLists = nullptr; CmdListsCount = TotalVtxCount = TotalIdxCount = 0; DisplayPos = DisplaySize = ImVec2(0.f, 0.f); } // The ImDrawList are owned by ImGuiContext!
...
struct ImFontAtlas
{
    ...
    IMGUI_API bool              IsBuilt()                   { return Fonts.Size > 0 && (TexPixelsAlpha8 != nullptr || TexPixelsRGBA32 != nullptr); }
